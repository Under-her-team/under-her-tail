...
function Battle_SetState() {
	...
	if(STATE==BATTLE_STATE.TURN_PREPARATION){
		...
		var MOVE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_MOVE_DURATION,room_speed/2);
		...
		var SIZE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_SIZE_DURATION,room_speed/2);
	...
	if(STATE==BATTLE_STATE.BOARD_RESETTING){
		...
		var MOVE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_MOVE_DURATION,room_speed/2);
		...
		var SIZE_DURATION=Battle_GetTurnInfo(BATTLE_TURN.BOARD_RESET_SIZE_DURATION,room_speed/2);
