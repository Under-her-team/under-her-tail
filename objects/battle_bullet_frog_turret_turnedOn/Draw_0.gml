...
draw_sprite_ext(spr_bullet_frogette_fly,0,x+_fly_x,y+_fly_y,1,1,0,c_white,_fly);
draw_sprite_ext(spr_bullet_frogette_tonguestrip,0,x,y,1,_tongue_length,_angle,c_white,1);
